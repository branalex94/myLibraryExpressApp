...
// Display book create from on GET
exports.book_create_get = function (req, res, next) {
  // Get all authors and genres, which we can use for adding to our new book
  async.parallel(
    {
...
exports.book_create_post = [
  ...
  (req, res, next) => {
    ...
    // Create a book oject with escaped and trimmed data.
    let book = new Book({
