...
// GET request for creating a bookinstance. NOTE: this must come before routes that displays bookinstance. (uses id)
router.get(
  "/bookinstance/create",
...
router.get("/bookinstances", book_instance_controller.bookinstace_list);
